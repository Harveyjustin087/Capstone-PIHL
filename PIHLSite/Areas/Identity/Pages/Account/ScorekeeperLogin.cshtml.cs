...
{
    [AllowAnonymous]
    public class ScorekeeperLoginModel : PageModel
    {
        private readonly UserManager<PIHLSiteUser> _userManager;
        private readonly SignInManager<PIHLSiteUser> _signInManager;
        private readonly ILogger<ScorekeeperLoginModel> _logger;

        public ScorekeeperLoginModel(SignInManager<PIHLSiteUser> signInManager, 
            ILogger<ScorekeeperLoginModel> logger,
